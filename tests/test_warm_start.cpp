...
// pdip_tol -- it only cuts interior-point iterations when consecutive poses
// are close. Also: the trust-region fallback (a big pose jump still solves
// correctly, cold) and the KKT-residual guard.
